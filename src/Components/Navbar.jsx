        ...
        <nav className='md:flex justify-between items-center mx-auto  tracking-tight'>
            ...
            <div className='hidden md:flex justify-between items-center space-x-2 font-sans font-medium text-md'>
              ...
              <form className='flex items-center justify-between relative'>
                <input type="search" placeholder='Search an image' className='rounded-md  p-2 h-[2.5rem] w-full text-gray-900 outline-indigo-600 bg-gray-100' />
                <button type="submit">
                ...
                <a className='text-blue-300 border-2 border-blue-300 rounded-md py-2 px-3' href="#">Sign up</a>
            </div>
             {/* Mobile view */}
