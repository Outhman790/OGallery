...
function Navbar() {
  ...
  return (
    <nav className="container flex justify-between items-center p-4 md:p-0 mx-auto">
      {/* Logo and Brand Name */}
      <div
        className={`absolute inset-0 z-10 p-4 text-center ${
          window.location.pathname === "/gallery" ? "bg-purple-100" : "bg-white"
        }  w-full h-fit md:w-auto  md:static flex justify-center items-center gap-1 md:bg-transparent md:gap-1 md:m-0 md:p-0 text-purple-600`}
      >
